 ...
 * must never diverge"), with auto-generated zoom/pan and an animated
 * cursor overlay. No style panel (background/padding/shadow) or export
 * yet — see ARCHITECTURE.md for what's still ahead of this.
 */
export function EditorView({ bundlePath, onClose }: { bundlePath: string; onClose: () => void }) {
  ...
  return (
    <div className="flex h-screen w-screen flex-col items-center justify-center gap-4 bg-neutral-950 p-6 text-neutral-300">
